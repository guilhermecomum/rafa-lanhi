    ...
    <div className="flex flex-col lg:flex-row w-full lg:w-8/12 lg:mx-auto px-4 my-4 lg:my-10 text-gray-600 text-lg items-start">
      ...
      <div className="text-justify mt-8 lg:m-0">
        ...
        <p className="pt-4 indent-6">
          Olá, sou Rafaela Lanhi, fisioterapeuta e acupunturista, e minha maior
          satisfação é trazer bem estar para as pessoas através das técnicas da
          medicina chinesa somadas a formação em fisioterapia.
        </p>
        <p className="pt-4 indent-6">
          ...
          saúde que considerasse o ser humano como um todo (sobre seus aspectos
          físicos, mentais e o todo ao seu redor).
        </p>
        <p className="pt-4 indent-6">
          ...
          gostaria de seguir. Nesta caminhada fiz especialização em Ortopedia e
          Traumatologia, Fisioterapia do Trabalho e Pilates, com vários
        ...
        <p className="pt-4 indent-6">
          A Acupuntura, não foi minha primeira escolha de especialização e hoje
          consigo perceber que tudo que fiz antes era necessário para abrir
          ainda mais meu olhar sobre o ser humano em sua totalidade. Assim, há 4
          anos atrás, quando iniciei minha formação em Acupuntura, também abri
          espaço para uma mudança interna, pessoal e profissional, que precisava
          destes anos todos para poder acontecer de verdade.
        </p>
        <p className="pt-4 indent-6">
          ...
          delicadeza que é poder cuidar da saúde das pessoas considerando todos
          os aspectos que envolvem o bem-estar e a qualidade de vida de cada
          indivíduo e o meio aonde eles estão.
        </p>
        <p className="pt-4">
