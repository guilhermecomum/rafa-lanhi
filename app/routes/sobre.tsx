export default function Sobre() {
  return (
    <div className="flex flex-col w-full lg:w-8/12 lg:mx-auto px-4 mb-8">
      <h2 className="font-semibold text-pink text-center text-4xl my-4 md:my-6">
        Sobre
      </h2>
      <div className="text-gray-600 text-lg flex lg:flex-row flex-col justify-between items-start">
        <img
          className="object-contain w-full lg:w-2/6 mb-4 mr-10"
