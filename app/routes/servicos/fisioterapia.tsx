    ...
    <div>
      <div className="text-gray-600 lg:bg-green-50 lg:p-8">
        ...
        <p className="pt-4 text-justify  indent-6">
          ...
          da saúde habilitada para promover, desenvolver, manter e reabilitar as
          capacidades de movimento e funcionalidade do indivíduo ao longo da sua
          vida
        </p>
        ...
        <p className="pt-4 text-justify  indent-6">
          ...
          a tudo aquilo que é oferecido pelo espaço que cada um vive, pelo que
        ...
        <p className="pt-4 text-justify  indent-6">
          ...
          movimento. Se não oferecermos mobilidade, facilmente nos adaptarmos a
          inércia.
        </p>
        ...
        <p className="pt-4 text-justify  indent-6">
          ...
          nossas necessidades. Para mim é difícil pensar em saúde física sem que
          ela esteja conectada com as atividades que nos rodeiam, os espaços que
          ocupamos e o quanto este conjunto de itens é o que nos proporciona
        ...
        <p className="pt-4 text-justify  indent-6">
          ...
          juntos exercícios para melhorar, corrigir posturas que possam provocar
          desconforto, fazer ajustes em casa e no trabalho para evitar esses
          quadros.
        </p>
