...
export default function Index() {
  return (
    <main className="relative lg:flex lg:items-center lg:justify-center flex flex-col">
      <section className="flex flex-col lg:py-10 lg:grid lg:grid-cols-12 lg:px-4 lg:items-center">
        ...
        <div className="col-start-7 col-span-5 px-4">
          ...
          <div className="text-center mb-8">
            <button className="bg-pink py-2 w-full lg:w-auto px-4 mt-8 rounded-xl text-white text-xl font-semibold self-center">
              agendar
            </button>
          </div>
        </div>
      </section>
      <section className="w-full bg-pink lg:bg-white-flower lg:bg-half-center lg:h-[80vh] lg:bg-no-repeat flex flex-col text-white">
      ...
      <section className="bg-green-50 lg:bg-pink-flower lg:bg-half lg:bg-no-repeat lg:grid lg:grid-cols-12 px-4 py-14">
